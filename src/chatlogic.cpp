...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot _chatBotNew("../images/chatbot.png"); // Local instance of ChatBot
    _chatBotNew.SetChatLogicHandle(this); //
    // add chatbot to graph root node
    _chatBotNew.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(_chatBotNew));
}
